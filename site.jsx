    ...
    <>
      <header className="nav-wrapper">
        <div className={"nav-island" + (scrolled ? " is-scrolled" : "")}>
          <a href="/" className="nav-logo" aria-label="Somos Bro · home">
          ...
          <Magnetic strength={0.25}>
            <a className="btn btn-primary nav-cta-desktop" href="/contacto" style={{padding:"10px 18px",fontSize:13}}>
              Hablemos
              <svg className="btn-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M7 17 17 7M9 7h8v8"/></svg>
            </a>
          </Magnetic>
        ...
        <div className="footer-top">
          ...
          <div className="footer-cols">
            ...
            <div className="footer-col"><h5>Servicios</h5>
              <a href="/servicios">Creación de contenido</a>
              <a href="/servicios">Marca personal</a>
              <a href="/servicios">Diseño web</a>
              <a href="/servicios">Branding</a>
              <a href="/servicios">Logos</a>
            </div>
